...
import 'popular_movies_detail_page.dart';
import 'popular_movies_main_page.dart';
        ...
        if (routeSettings.name == 'detailPage') {
          ...
          return CupertinoPageRoute(
              builder: (BuildContext context) =>
                  (PopularMoviesDetailPage(movie)));
        } else {
          return CupertinoPageRoute(
              builder: (BuildContext context) => (PopularMoviesMainPage()));
        }
      },
